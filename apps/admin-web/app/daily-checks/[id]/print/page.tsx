...
interface DailyCheckPrintPageProps {
  params: {
    id: string;
  };
  searchParams?: {
...
export default function DailyCheckPrintPage({ params, searchParams }: DailyCheckPrintPageProps) {
  ...
  return (
    <main>
      <TenantDailyCheckDetailsPage id={params.id} host={tenantHost} printMode subdomain={subdomain} />
    </main>
  );
}
